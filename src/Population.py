...
class Population(object):
    ...
    def get_from_parent_and_environment(self): #parental inheritance and environmental acquisition 
        ...
        for i in range(self.number_of_individual): #select parent for next generation
            parental_contribution.append(self.composition_of_individual[random.randint(0, self.number_of_environmental_species-1)].microbiome/float(self.number_of_individual_species))
