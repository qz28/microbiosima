...
class Population:
    def __init__(self,species_registry,environment,number_of_individual,number_of_individual_species,gene_fitness,environmental_factor,pooled_or_fixed,host_selection):
        ...
        self.composition_of_individual=[Individual(environment,number_of_individual_species,species_registry,gene_fitness,host_selection) for k in range(number_of_individual)] 
    ...
    def get_from_parent_and_environment(self): #parental inheritance and environmental acquisition 
        ...
        for i in range(self.number_of_individual): #mix environmental and parental contribution
            ...
            self.composition_of_individual[i].weighted_fitness=host_selection**new_fitness#no selection
