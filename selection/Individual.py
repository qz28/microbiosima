...
class Individual:
    def __init__(self,environment,number_of_individual_species,species_registry,gene_fitness,host_selection): # the host
        ...
        self.weighted_fitness=host_selection**(self.fitness)
