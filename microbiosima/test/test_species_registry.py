...
class TestSR(unittest.TestCase):
    ...
    def test_find_species(self):
        ...
        self.assertEqual(sorted([self.species_registry.find_species([4,1]),self.species_registry.find_species([4,2]),self.species_registry.find_species([4,4])]),[4,5,6])
        self.assertEqual(sorted([self.species_registry.fitness_list[4],self.species_registry.fitness_list[5],self.species_registry.fitness_list[6]]),[0.5,1,2])
