...
public class Microbiosima {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException, IOException {
        ...
        PrintWriter file5= new PrintWriter(new BufferedWriter(new FileWriter(prefix+"_inter_generation_distance.txt")));
        PrintWriter file6= new PrintWriter(new BufferedWriter(new FileWriter(prefix+"_environment_population_distance.txt")));
//		

        Population population=new Population(Nm, environment, Nh, environmental_factor , pooled_or_fixed,0,0);
